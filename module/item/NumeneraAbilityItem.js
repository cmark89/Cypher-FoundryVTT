...
export class NumeneraAbilityItem extends Item {
  ...
  prepareData() {
      ...
      itemData.name = this.data ? this.data.name : game.i18n.localize("CYPHER.item.ability.newAbility");
  ...
  async updateRelatedSkill(skill, options = {}) {
    ...
    ui.notifications.info(game.i18n.localize("CYPHER.item.ability.relatedSkillUpdated"));
